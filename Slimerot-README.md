...
Prompt 15 adds permanent Dash, pooled combat feedback/projectiles, normal Shooter friendly fire, staged boss patterns, one combined boss/exit gate, first-unlock presentation and 41 original environment SVGs. Existing RNG/progression remains authoritative. See the [Prompt 15 report](docs/Slimerot-Prompt-15.md) for boss changes, save compatibility, assets, provisional tuning and tests.

Prompt 16 reduces measured grind walls through provisional HP, gate, income and skill-price tuning, preserves historical purchase ledgers, summarizes overflowed power-record reveals, and completes migration, stress and offline-source audits. Exact RNG/variant/damage formulas remain unchanged. See the [balance measurements](docs/Slimerot-Prompt-16-Balance.md), [save and process-death results](docs/Slimerot-Prompt-16-Saves.md), [192-outcome power table](docs/Slimerot-Prompt-16-Power-Table.md), and [complete provisional-number inventory](docs/Slimerot-Prompt-16-Provisional.md). Desktop automated acceptance passes; physical Android and human playfeel acceptance remain pending.
...
After R08, Settings → Rolling exposes MAX / x20-era / x1. MAX is the initial and first-Breakthrough default. Caps are absolute persistent/potion rolling-luck ceilings of none / 20 / 1. Super Roll applies its current tier’s temporary ×5 / ×10 / ×20 after the selected cap, preserving that exact multiplier in every mode. Combat and uncapped luck statistics are unchanged.

## Complete Roll progression

`SlimerotRollTree.gd` centralizes all 18 mandatory nodes R01–R18 and nine optional nodes RO1–RO9, with exact costs, prerequisites, descriptions and effects. R01 is the mainline starting node. Repairing the Bedroom Shrine adds the Skills HUD button and opens the Roll/Coin tree canvases. Optional purchases never become mainline prerequisites.

Provisional mandatory spending blocks are 600 / 795 / 1,125 Rolls. R08 costs 225 Rolls, R13 costs 325, and R18 costs 325. Quick Hands sets cooldowns to 2.20 / 1.90 / 1.55 / 1.25 / 1.00 / 0.80 / 0.65 seconds. RO7 is the provisional 350-Roll post-campaign 0.50-second upgrade. Derived minor multipliers and exactly x20 per Breakthrough yield x30.36 / x910.8 / x28,462.5 before Fortune, zones or potions. The Breakthrough component alone is exactly ×20 / ×400 / ×8,000. Nothing destructively multiplies saved luck.
...
Provisional gate prices from Z1 through Z8 are 150 / 1,000 / 4,000 / 9,000 / 45,000 / 180,000 / 900,000 / 0 Coins, with 12 / 20 / 25 / 30 / 40 / 40 / 45 / 30 kills. Gates never require a specific slime or mandatory Breakthrough. Boss flags remain mandatory at Z2/Z4/Z6/Z8. One combined gate opens the boss fight after the kills, then becomes the priced next-zone gate after the clear. Z8 victory unlocks the completion portal.

Prompt 16 reduces Chaser/Shooter/Tank HP to 1,900/3,000/5,500 in Z4, 4,000/6,500/12,000 in Z5, 6,500/10,500/20,000 in Z6, 13,000/21,000/40,000 in Z7, and 20,000/32,000/60,000 in Z8. Z3–Z7 normal-enemy Coin income doubles. Contact damage, boss reward amounts, rarity thresholds, variant power and all three x20 effects remain unchanged. These provisional data changes were selected from measured progression gaps; exact deltas and seeded results are in the [Prompt 16 balance report](docs/Slimerot-Prompt-16-Balance.md). XP, online systems, monetization and prestige remain outside this project.

## Bosses, structures and completion

SlimerotEncounters.gd centralizes all boss profiles, structures and recipes. Espresso Golem has 3,000 HP, contact 16, a 3s chase then 0.8s warning/slam for 24, and rewards 1,000 Coins plus a Lucky Soda. Sand Router has 50,000 HP, contact 35, a telegraphed five-way 50-damage fan every 4s, and rewards 20,000 Coins plus Hyper Soda. Backrooms Janitor has a provisional 150,000 HP, contact 65, teleports among four points every 6s and fires two aimed three-shot 80-damage bursts; its reward is 350,000 Coins. Singularity Admin has a provisional 600,000 HP, contact 110, alternating fan/teleport shots for 140, and adds shrinking 170-damage warning circles at 40% HP; victory gives 6,000,000 Coins and the completion portal.
