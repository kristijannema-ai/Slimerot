...
const MAINLINE := [
	...
	["R08", "BREAKTHROUGH I: RNG Overdrive", "R07", 900, "checkpoint_luck", 20.0, "TOTAL luck ×20 · unlock Luck Cap"],
	...
	["R13", "BREAKTHROUGH II: Viral Cascade", "R12", 1300, "checkpoint_luck", 20.0, "TOTAL luck ×20 again"],
